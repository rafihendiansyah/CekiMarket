...
class SellerRegistrationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            // Dokumen Identitas
            'picNumber'   => ['required', 'string', 'max:50'],
            'picPhoto'    => ['nullable', 'image', 'mimes:jpg,jpeg,png', 'max:2048'],
            'picKtpFile'  => ['nullable', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:5120'],
        ]);
        ...
        if ($request->hasFile('picKtpFile')) {
            $validated['picKtpPath'] = $request->file('picKtpFile')->store('seller/ktp', 'public');
        }
